 ...
 */
public fun Json(from: Json = Json, builderAction: JsonBuilder.() -> Unit): Json {
...
@Deprecated(
    ...
    message = "Deprecated in the favour of Json {} builder function during serialization 1.0 API stabilization.\n" +
            ...
            "Json(JsonConfiguration.Stable) can be replaced with Json companion instead."
)
@Suppress("DEPRECATION_ERROR")
public fun Json(
...
public fun Json(
    configuration: SubtypeToDetectDefaults
): Json = error("Deprecated and should not be called")
...
public fun Json(
    configuration: SubtypeToDetectDefaults, context: SerializersModule
): Json = error("Deprecated and should not be called")
