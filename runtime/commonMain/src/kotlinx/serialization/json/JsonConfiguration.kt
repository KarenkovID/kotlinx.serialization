...
public open class JsonConfiguration(
    ...
    public companion object {
         ...
         */
        @JvmStatic
        public val Default: SubtypeToDetectDefaults = SubtypeToDetectDefaults()
         ...
         */
        @JvmStatic
        public val Stable: SubtypeToDetectDefaults = SubtypeToDetectDefaults()
    }
}

@Suppress("DEPRECATION_ERROR")
public class SubtypeToDetectDefaults : JsonConfiguration()
